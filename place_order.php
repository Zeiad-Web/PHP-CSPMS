    ...
    <div class="container">
        <div class="card card-outline card-dark shadow rounded-0">
            <div class="card-header">
                <h4 class="card-title">ارسال الطلب</h4>
            </div>
            <div class="card-body">
                <form action="" id="place_order">
                    <div class="form-group">
                        <label for="delivery_address" class="control-label">عنوان التسليم</label>
                    ...
                    <div class="form-group text-right">
                        <button class="btn btn-flat btn-primary">ارسال الطلب</button>
                    </div>
                </form>
            </div>
        </div>
