...
<div class="col px-1 py-2 text-decoration-none text-dark product-item">
                    <div class="">
                        <div class="img-top position-relative product-img-holder">
                            <img src="<?= validate_image(isset($image_path) ? $image_path : "") ?>" alt="serv Image <?= isset($name) ? $name : "" ?>" >
                        </div>
                    </div>
    <dl>
    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="form-group">
                    ...
                    <select name="service_id[]" id="service_id" class="form-select form-select-sm  rounded-0">
                    <?php 

                    $service = $conn->query("SELECT * FROM `service_list` where id = '{$_GET['id']}'");
                ...
                <div class="form-group">
                    ...
                    <select name="service_type" id="service_type" class="form-select form-select-sm  rounded-0" required>
                        <!--<option>الغاء</option>-->
                        <option>مكنيك</option>
                ...
                <div class="form-group" style="display:none">
                    <label for="pickup_address" class="control-label">عنوان الاستلام</label>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">ارسال الطلب</button>
                <button class="btn btn-dark btn-sm rounded-0" type="button" data-dismiss="modal">خروج</button>
            </div>
        </div>
    </form>
</div>
