<div class="content py-5 mt-3">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-center">الوكالات المتوفرة في متجرنا</h3>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="search" id="search" class="form-control" placeholder="........ ابحث هنا" aria-label="Search brand Here" aria-describedby="basic-addon2" style=" text-align: right;">
                </div>
                </div>
...
<script>
    $(function(){
        ...
        $('#send_request').click(function(){
            ...
            uni_modal("إملأ نموذج طلب العلامة التجارية","send_request.php",'mid-large');
            else
