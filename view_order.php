        ...
        <div class="col-md-6">
            ...
            <div class="ml-3">
                <?php if(isset($status)): ?>
                    ...
                    <?php elseif($status == 4): ?>
                        <span class="badge badge-default bg-gradient-teal px-3 rounded-pill">تم التسليم</span>
                    <?php else: ?>
    ...
    <div class="row">
        <div class="col-12 text-right">
            ...
            <div class="form-group">
                    <br>
                <select  class="custom-select select2"  style="text-align:right;">
                    <option>اختر طريقة الدفع</option>
                    <option value="">كاش</option>
                    <option value="">ون كاش</option>
                    <option value="">محفظتي</option>
                    <option value="">فلوسك</option>
                    <option value="">كاش</option>
                    <option value="">ون كاش</option>
                    <option value="">محفظتي</option>
                    <option value="">فلوسك</option>
            ...
            <button class="btn btn-blue btn-flat btn-sm" type="button" data-dismiss="modal"  style="background: blue; color: white;">مواصلة</button>
        </div>
    </div>
</div>
<script>
