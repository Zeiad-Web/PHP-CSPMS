...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">قائمة الوكالات</h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  اضافة جديد</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-center">
                                <?php if($row['status'] == 1): ?>
                                    <span class="badge badge-success mx-3 rounded-pill">نشط</span>
                                <?php else: ?>
                                    <span class="badge badge-danger mx-3 rounded-pill">غير نشط</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("هل انت متأكد من حذف الوكالة من النظام","delete_brand",[$(this).attr('data-id')])
		})
        $('#create_new').click(function(){
            uni_modal("اضافة وكالة جديدة","maintenance/manage_brand.php","mid-large")
        })
        $('.edit_data').click(function(){
            uni_modal("تعديل الوكالة","maintenance/manage_brand.php?id="+$(this).attr('data-id'),"mid-large")
        })
