...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=maintenance/manage_service" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  اضافة جديد</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=maintenance/manage_service&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> تعديل</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("هل انت متأكد من حذف الخدمة","delete_service",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
