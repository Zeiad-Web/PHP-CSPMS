...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  اضافة جديد</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo ($row['type'] == 1) ? 'مشرف' : 'عامل' ?></td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("هل انت متأكد من حذف هذا المستخدم","delete_user",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
