...
?>
<div class="card card-primary card-outline" style= "text-align: right;">
    ...
    <div class="card-body">
        ...
        <div id="printable">
            ...
            <h4 class="text-center m-0"><?php echo $_settings->info('name') ?></h4>
                <h3 class="text-center m-0"><b>تقرير الطلبات </b></h3>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center" colspan="6">لاتوجد بيانات.......</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
