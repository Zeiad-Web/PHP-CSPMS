...
<div class="card card-primary card-outline" style= "text-align: right;">
    ...
    <h5 class="card-title">تقارير طلب خدمة السيارات</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
        ...
        <div id="printable">
            ...
            <h4 class="text-center m-0"><?php echo $_settings->info('name') ?></h4>
                <h3 class="text-center m-0"><b>تقرير طلب الخدمة</b></h3>
                    ...
                    <tr>
                        ...
                        <td class='text-center'>
                            ...
                            <?php elseif($row['status'] == 4): ?>
                                <span class="badge badge-danger rounded-pill px-3">نم الالغاء</span>
                            <?php else: ?>
