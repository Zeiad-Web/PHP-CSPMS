	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">الاسم المصغر للنظام</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label">عنا</label>
			...
			<div class="form-group">
				<label for="" class="control-label">ايقونة النظام</label>
			...
			<div class="form-group">
				<label for="" class="control-label">خلفية الموقع</label>
				<div class="custom-file">
