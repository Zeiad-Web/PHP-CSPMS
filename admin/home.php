<h1 class="" style="text-align:right;"> Welcome To <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row" style="text-align:right;">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">اجمالي الوكالات</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">اجمالي الفئات</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">اجمالي المختصين</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">الطلبات المعلقة</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">الطلبات المؤكدة</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">طلبات تحت التوصيل</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">طلبات على الطريق</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">الطلبات الموصلة</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">الطلبات منتهية التوصيل</span>
                <span class="info-box-number">
                <?php 
