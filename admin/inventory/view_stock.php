...
<div class="content py-3">
    <div class="card card-outline rounded-0 card-primary shadow">
        <div class="card-header">
            <h4 class="card-title">كمية/مخزون المنتج</h4>
            <div class="card-tools">
                <a href="javascript:void(0)" id="add_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  اضافة كمية جديدة</a>
                <a class="btn btn-default border btn-sm btn-flat" href="./?page=inventory"><i class="fa fa-angle-left"></i> خروج</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <small class="mx-2 text-muted">اسم الوكالة</small>
                                <div class="pl-4"><?= isset($brand) ? $brand : '' ?></div>
                            </div>
                            <div class="col-md-6">
                                <small class="mx-2 text-muted">الفئة</small>
                                <div class="pl-4"><?= isset($category) ? $category : '' ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <small class="mx-2 text-muted">الموديل</small>
                                <div class="pl-4"><?= isset($models) ? $models : '' ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <small class="mx-2 text-muted">الاسم</small>
                                <div class="pl-4"><?= isset($name) ? $name : '' ?></div>
                            </div>
                            <div class="col-md-6">
                                <small class="mx-2 text-muted">السعر</small>
                                <div class="pl-4"><?= isset($price) ? number_format($price,2) : '' ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <small class="mx-2 text-muted">الكمية المتاحة</small>
                                <div class="pl-4"><?= isset($available) ? number_format($available) : '0' ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h3>تاريخ الكمية/المخزون</h3>
                        <table class="table table-bordered table-stripped">
                            ...
                            <thead>
                                <tr class="bg-light text-light">
                                    <th class="py-1 text-center">تارخ الاضافة</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-1 align-middle">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item edit_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-dark"></span> تعديل</a>
...
<script>
    $(document).ready(function(){
        $('#add_new').click(function(){
			uni_modal("اضافة كمية جديدة","inventory/manage_stock.php?pid=<?= isset($id) ? $id : "" ?>")
		})
        $('.edit_data').click(function(){
			uni_modal("تعديل الكمية","inventory/manage_stock.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("هل انت متأكد من حذف كمية/مخزون المنتج؟","delete_stock",[$(this).attr('data-id')])
		})
    })
