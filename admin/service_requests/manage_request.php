...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="vehicle_type" class="control-label">نوع السيارة</label>
                ...
                <div class="form-group">
                    <label for="owner_name" class="control-label">الاسم الكامل للعميل</label>
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">هاتف العميل</label>
                ...
                <div class="form-group">
                    <label for="email" class="control-label">ايميل العميل</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="vehicle_name" class="control-label">اسم السيارة</label>
                ...
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">رقم تسجيل السيارة</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">موديل السيارة</label>
                ...
                <div class="form-group">
                    <label for="service_id" class="control-label">الخدمة</label>
                ...
                <div class="form-group">
                    <label for="service_type" class="control-label">نوع الخدمة</label>
                    <select name="service_type" id="service_type" class="form-select form-select-sm select2 rounded-0" required>
                        <option <?php echo isset($service_type) && $service_type == 'Drop Off' ? "selected" : '' ?>>مكنيك</option>
                        <option <?php echo isset($service_type) && $service_type == 'Pick Up' ? "selected" : '' ?>>كهرباء</option>
                        <option <?php echo isset($service_type) && $service_type == 'Pick Up' ? "selected" : '' ?>>اخرئ</option>

                    </select>
                </div>
                <div class="form-group" <?php echo isset($service_type) && $service_type == 'Drop Off' ? 'style="display:none"' : '' ?>>
                    <label for="pickup_address" class="control-label">عنون الاستلام</label>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group " id="mechanic-holder">
                    <label for="mechanic_id" class="control-label">المختص</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                        <option value="0" <?php echo isset($status) && $status == 0 ? "selected" : '' ?>>انتظار</option>
                        <option value="1" <?php echo isset($status) && $status == 1 ? "selected" : '' ?>>تم التأكيد</option>
                        <option value="2" <?php echo isset($status) && $status == 2 ? "selected" : '' ?>>قيد التقدم</option>
                        <option value="3" <?php echo isset($status) && $status == 3 ? "selected" : '' ?>>تم</option>
                        <option value="4" <?php echo isset($status) && $status == 4 ? "selected" : '' ?>>تم الالغاء</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">حفظ الطلب</button>
                <button class="btn btn-light btn-sm rounded-0" type="button" data-dismiss="modal">خروج</button>
            </div>
        </div>
    </form>
</div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    if(resp.status == 'success'){
                        ...
                        setTimeout(() => {
                            uni_modal("قائمة عرض الخدمة","service_requests/view_request.php?id="+resp.id,'large')
