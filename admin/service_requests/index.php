...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">قائمة طلب الخدمات</h3>
							...
							<td style=" align:center;">
								 ...
								 الاجراء
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> عرض</a>
...
<script>
	$(document).ready(function(){
		...
		$('.view_data').click(function(){
			uni_modal("قائمة عرض الخدمة","service_requests/view_request.php?id="+$(this).attr('data-id'),'large')
		})
		$('#create_new').click(function(){
			uni_modal("قائمة عرض الخدمة","service_requests/manage_request.php",'large')
		})
		$('.edit_data').click(function(){
			uni_modal("قائمة عرض الخدمة","service_requests/manage_request.php?id="+$(this).attr('data-id'),'large')
		})
		$('.table').dataTable();
	})
