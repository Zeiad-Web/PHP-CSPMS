...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> المخزون/الكمية</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="quantity" class="control-label">الكمية الاولية</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=inventory">خروج</a>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
        $('.select2').select2({placeholder:"اختر هنا",width:"relative"})
