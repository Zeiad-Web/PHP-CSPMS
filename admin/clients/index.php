...
<?php endif;?>
<div class="card card-outline card-primary"  style=" text-align: right;">
					...
					?>
						<tr>
							...
							<td class="text-center">
                                <?php if($row['status'] == 1): ?>
                                    <span class="badge badge-success rounded-pill px-3">نشط</span>
                                <?php else: ?>
                                    <span class="badge badge-danger rounded-pill px-3">غير نشط</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=clients/manage_client&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> تعديل</a>
