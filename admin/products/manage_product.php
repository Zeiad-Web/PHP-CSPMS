...
?>
<div class="card card-outline card-info rounded-0" style= " text-align: right; " >
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "تحديث ": "انشئ منتج " ?> جديد</h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
				<label for="brand_id" class="control-label">الوكالة</label>
            ...
            <div class="form-group">
				<label for="category_id" class="control-label">الفئة</label>
			...
			<div class="form-group">
                ...
                <input name="name" id="name" type="text" class="form-control rounded-0"style= " text-align: right; " value="<?php echo isset($name) ? $name : ''; ?>" required>
			</div>
			<div class="form-group">
				<label for="models" class="control-label">التوافق: <small>(الموديل)</small></label>
                <input name="models" id="models" type="text" class="form-control rounded-0"style= " text-align: right; " value="<?php echo isset($models) ? $models : ''; ?>" required>
			</div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="custom-select selevt" style= " text-align: right; ">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=products">خروج</a>
	</div>
</div>
<script>
