...
<div class="content py-3" style=" text-align: right;">
    <div class="card card-outline rounded-0 card-primary shadow">
        <div class="card-header">
            <h4 class="card-title">المنتج</h4>
            <div class="card-tools">
                <a class="btn btn-primary btn-sm btn-flat" href="./?page=products/manage_product&id=<?= isset($id) ? $id : "" ?>"><i class="fa fa-edit"></i> تعديل</a>
                <a class="btn btn-danger btn-sm btn-flat" href="javascript:void(0)>" id="delete_data"><i class="fa fa-trash"></i> حذف</a>
                <a class="btn btn-default border btn-sm btn-flat" href="./?page=products"><i class="fa fa-angle-left"></i> خروج</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <small class="mx-2 text-muted">الوصف</small>
                        <div class="pl-4"><?= isset($description) ? html_entity_decode($description) : '' ?></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <small class="mx-2 text-muted">الحالة</small>
                        <div class="pl-4">
                            <?php if(isset($status)): ?>
                            <?php if($status == 1): ?>
...
<script>
    $(document).ready(function(){
		$('#delete_data').click(function(){
			_conf("هل انت متأكد من حذف الطلب","delete_product",[])
		})
    })
