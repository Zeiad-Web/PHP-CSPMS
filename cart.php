...
<div class="content py-5 mt-3">
    <div class="container" style=" text-align: right;">
        <h3><b>سلة التسوق الخاصة بي</b></h3>
        <hr>
                    ...
                    <div class="col-auto flex-grow-1 flex-shrink-1 px-1 py-1">
                        <div class="d-flex align-items-center w-100 ">
                            ...
                            <div class="col-auto flex-grow-1 flex-shrink-1">
                                ...
                                <button class="btn btn-sm btn-flat btn-outline-danger btn-remove" data-id="<?= $row['id'] ?>"><i class="fa fa-times"></i> حذف</button>
                            </div>
                         </div>
                    </div>
        ...
        <div class="text-right">
            <button class="btn btn-flat btn-sm btn-dark" type="button" id="checkout">   المـــتابــعــة</button>
        </div>
    </div>
</div>
<script>
    ...
    $(function(){
        ...
        $('.btn-remove').click(function(){
            _conf("هل أنت متأكد من إزالة هذا المنتج من قائمة عربة التسوق؟","remove_from_cart",[$(this).attr('data-id')])
        })
        $('#checkout').click(function(){
            if($('#cart-list .cart-item').length > 0){
                location.href="./?p=place_order"
            }else{
                alert_toast('عربة السلة فارغة.','error')
            }
        })
    })
