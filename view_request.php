...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="ml-3">
                <?php if(isset($status)): ?>
                    <?php if($status == 1): ?>
                    <span class="badge badge-primary rounded-pill px-3">تم التأكيد</span>
                    <?php elseif($status == 2): ?>
                        <span class="badge badge-warning rounded-pill px-3">قيد التقدم</span>
                    <?php elseif($status == 3): ?>
                        <span class="badge badge-success rounded-pill px-3">تم</span>
                    <?php elseif($status == 4): ?>
                        <span class="badge badge-danger rounded-pill px-3">تم الالغاء</span>
                    <?php else: ?>
                        <span class="badge badge-secondary rounded-pill px-3">انتظار</span>
                    <?php endif; ?>
                <?php else: ?>
                    N/A
                <?php endif; ?>
    ...
    <!--<div class="row">
        <div class="col-md-6">
            <label for="" class="text-muted">نوع الخدمة</label>
        ...
        ?>
        <div class="col-md-6">
            <label for="" class="text-muted">عنوان الاستلام</label>
    ...
    <div class="row">
        <div class="col-12 text-right">
            ...
            <button class="btn btn-danger btn-flat btn-sm" id="btn-cancel" type="button">الغاء الطلب</button>
            <?php endif; ?>
            <button class="btn btn-dark btn-flat btn-sm" type="button" data-dismiss="modal"><i class="fa fa-times"></i> خروج</button>
        </div>
    </div>
</div>
<script>
    $('#btn-cancel').click(function(){
        _conf("هل انت متأكد من الغاء الطلب","cancel_service",[])
    })
