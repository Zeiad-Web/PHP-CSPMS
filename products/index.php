            ...
            <div class="col-md-4">
                ...
                <div class="card card-outline shadow card-primary rounded-0">
                    <div class="card-header">
                        <h3 class="card-title"><b>وكالات السيارات</b></h3>
                    </div>
                    <div class="card-body">
                        <ul class="list-group">
                ...
                <div class="card card-outline shadow card-primary rounded-0">
                    <div class="card-header">
                        <h3 class="card-title"><b>الفئات</b></h3>
                    </div>
                    <div class="card-body">
                        <ul class="list-group">
                    ...
                    <div class="col-md-12">
                        <form action="" id="search_prod">
                            <div class="input-group">
                                ...
                                <input type="search" name="search" value="<?= $search ?>" class="form-control" placeholder=".... ابحث هنا" style=" text-align: right;">
                            </div>
                        </form>
                    </div>
                </div>
