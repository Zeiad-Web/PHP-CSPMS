        ...
        <div class="card card-outline rounded-0 card-primary shadow">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a class="btn btn-default border btn-sm btn-flat" href="javascript:void(0)" id="add_to_cart"><i class="fa fa-cart-plus"></i> اضافة الى السلة</a>
                </div>
            </div>
            <div class="card-body">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <small class="mx-2 text-muted">موديل السيارة</small>
                            <div class="pl-4"><?= isset($models) ? $models : '' ?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <small class="mx-2 text-muted">اسم القطعة</small>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <small class="mx-2 text-muted">الكمية المتوفرة</small>
                    ...
                    $.ajax({
                        ...
                        success:function(resp){
                            if(resp.status =='success'){
                                ...
                                alert_toast(" تمت إضافة المنتج إلى سلة التسوق.",'success')
                            }else if(!!resp.msg){
